...
//        chatUrl.openStream()
    ...
    private void parseChatMessages(String loadedContent){
        ...
        try {
            ...
            if (content.has("data")){
                ...
                Log.d("parseChatMsg", "Content has not data" + loadedContent);
            }
        } catch (JSONException ex) {
            Log.d("parseChatMsg", ex.getMessage());
        }
    ...
    private static class ChatMessage {
        ...
        private static final SimpleDateFormat chatMomentFormat =
        ...
        try {
            ...
            throw new JSONException("Moment parse err" + ex.getMessage());
        }
